...
global data "C:\Projects\Trade_Informal_Employment\Data"
global output "C:\Projects\Trade_Informal_Employment\Output"
...
p512a p512b using "enaho01a-`year'-500.dta", clear
...
gen 	sec_siu = 1
replace sec_siu = 1 if ((p507==3 | p507==4 | p507==7) & (p510==1 | p510==2 | p510==3))
...
gen ocupinf =  .
replace ocupinf = (emp_siu==1 | emp_siu==3 | emp_siu==5 | emp_siu==7) 
replace ocupinf = . if ocupres==0
drop ocupres
